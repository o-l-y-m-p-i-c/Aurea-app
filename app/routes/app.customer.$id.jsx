...
import { BlockStack, Card, Layout, Link, Page, Text } from "@shopify/polaris";
...
export default function UserPage(){
    ...
    return <>
         <Page>
            ...
            <BlockStack gap="500">
                <a href="https://admin.shopify.com/store/aurea-dev/apps/new-app-735/app/customers" target={'_blank'}>
                {'< Back'}
                </a>
                                    ...
                                    return <>
                                        <div className="question" key={`question2-${index}`}>
                                            ...
                                            <div className="question-anserws">
                                               ...
                                               {note.questionType == 'text' && <button disabled key={`question-anserw-${1}-${1}`} className={`anserw ${true == true ? "hello" :"hidden"}`}>
                                                    {note.answer}
                                                </button>}
